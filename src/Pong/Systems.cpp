...
void EnemyInputEventSystem::run(SDL_Event event)
{
    scene->r.view<EnemyComponent, SpeedComponent>().each(
        [&](const auto &entity, EnemyComponent &player, SpeedComponent &speed)
        {
